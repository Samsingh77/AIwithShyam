...
// Only run setupServer if this file is being executed directly (not imported)
// On Vercel, this file is imported by api/index.ts, so we don't want to run setupServer
